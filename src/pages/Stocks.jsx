...
import { headers as headersData, domain, siteName, getDisplayNamesFromSearchParams, stocks } from "../lib/utils";
...
export default function Stocks() {
 ...
 const { displayNames, urlNames } = getDisplayNamesFromSearchParams(queryString1, headersData);
       ...
       <div className="flex flex-wrap gap-2">
        {displayNames.map((item) => (
         ...
         >
          ...
          <span>
           <X size={18} onClick={() => handleParamRemove(item.value)} />
          </span>
         </div>
        ))}
       </div>
