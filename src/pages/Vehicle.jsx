...
import { VehicleImages } from "../components/truck/truckImages";
    ...
    <div className="flex-col w-full max-w-6xl rounded-lg">
     ...
     <div className="flex flex-row place-content-center space-x-5">
      <div className="w-1/2 text-gray-700 space-y-6">
       ...
       <div className="space-y-6 p-9 rounded-3xl bg-red-100">
        <p className=" text-2xl font-semibold">Kleyn Trucks provides assurances you can rely on</p>

        <ul className="space-y-6">
         <li className="flex flex-row text-lg">
          <Check className="mr-2" color="green" /> TÜV Nord-certified inspection as standard
         </li>

         <li className="flex flex-row text-lg">
          <Check className="mr-2" color="green" /> Craftsmanship since 1919
         </li>

         <li className="flex flex-row text-lg">
          <Check className="mr-2" color="green" /> Trustpilot rating of 4.5
         </li>

         <li className="flex flex-row text-lg">
          <Check className="mr-2" color="green" /> Safe international logistics partner with AEO-status
         </li>

         <li className="flex flex-row text-lg">
          <Check className="mr-2" color="green" /> We speak your language
         </li>

         <li className="flex flex-row text-lg">
          <Check className="mr-2" color="green" /> Worldwide delivery
         </li>
        </ul>
       </div>
      </div>
      ...
      <div className="flex-col w-1/2 space-y-5">
       <div className="p-7 rounded-3xl bg-red-100 space-y-7">
        <div className="flex flex-row justify-between items-center">
         <p className="text-2xl font-semibold">Purchase price</p>
         <p className="text-2xl font-medium">
          {vehicle.currency} {vehicle.price} <span className="text-xs font-normal">{vehicle.currencySuffix}</span>
         </p>
        </div>
       ...
       <div className="p-7 rounded-3xl bg-red-100 space-y-3">
        <div className="flex flex-row justify-between items-center">
       ...
       <div className="border-1 border-gray-300 p-9 rounded-3xl space-y-3">
        <p className="text-2xl font-semibold">Contact us direct. We are open 6 days a week.</p>
